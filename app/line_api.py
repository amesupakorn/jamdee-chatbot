...
from app.quizMath import get_answered_math_questions, get_unanswered_math_question, load_math_questions, record_math_history
...
def send_quiz(user_id):
    ...
    quiz["mode"] = "quiz"  # ✅ สำคัญ! เพื่อให้ postback ส่ง mode ถูก
    flex = generate_quiz_flex(quiz, header_title="🧠 คำถามแสนสนุก")
...
def send_math_question(user_id):
    ...
    question["mode"] = "math"
    flex = generate_quiz_flex(question, header_title="➕ เกมบวกเลข")
